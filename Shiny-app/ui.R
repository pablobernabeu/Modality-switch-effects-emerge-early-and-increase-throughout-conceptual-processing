...
h5(HTML('<div style="width:900px; text-align:left; padding-left:30px; padding-right:30px; padding-bottom:15px; font-size:17px; line-height:1.6;"> This experiment was hosted and co-funded by the <a href="https://www.mpi.nl/department/neurobiology-language/4"> Neurobiology of Language department </a> at the <a href="https://www.mpi.nl"> Max Planck Institute for Psycholinguistics</a>. </div>')),
