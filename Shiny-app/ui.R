...
# Dashboard reference
h4(HTML('<div style="width:900px; background-color:#FEF9FF; padding-left:30px; padding-bottom:7px; padding-top:7px;"> Reference for this dashboard: </div>')),
h5(HTML('<div style = "width:900px; text-indent:-30px; padding-left:60px; padding-right:30px; padding-bottom:7px; font-size:15px;"> Bernabeu, P., Willems, R. M., & Louwerse, M. M. (2017). Modality switch effects emerge early and increase throughout conceptual processing: Evidence from ERPs [Data dashboard]. Retrieved from https://pablobernabeu.shinyapps.io/ERP-waveform-visualization_CMS-experiment/.</div>'), align = 'justify'),

# Paper info
h4(strong(HTML('<div style="width:900px; background-color:#FEF9FF; padding-left:30px; padding-bottom:7px; padding-top:7px;"> Paper </div>'))),
h5(HTML('<div style = "width:900px; text-indent:-30px; padding-left:60px; padding-right:30px; padding-bottom:7px; font-size:15px;"> Bernabeu, P., Willems, R. M., & Louwerse, M. M. (2017). <a href="https://mindmodeling.org/cogsci2017/papers/0318/index.html">Modality switch effects emerge early and increase throughout conceptual processing: Evidence from ERPs.</a> In G. Gunzelmann, A. Howes,  T. Tenbrink, & E. J. Davelaar (Eds.), <i>Proceedings of the 39th Annual Conference of the Cognitive Science Society</i> (pp. 1629-1634). Austin, TX: Cognitive Science Society. https://mindmodeling.org/cogsci2017/papers/0318/</div>'), align = 'justify'),
h5(strong(HTML('<div style="width:900px; background-color:#FDFCFF; padding-left:30px; font-size:15px; padding-bottom:6px; padding-top:6px;"> Abstract </div>'))),
h5(HTML('<div style="width:900px; padding-left:30px; padding-right:30px; padding-bottom:15px; font-size:15px;"> We tested whether conceptual processing is modality-specific by tracking the time course of the Conceptual Modality Switch effect. Forty-six participants verified the relation between property words and concept words. The conceptual modality of consecutive trials was manipulated in order to produce an Auditory-to-visual switch condition, a Haptic-to-visual switch condition, and a Visual-to-visual, no-switch condition. Event-Related Potentials (ERPs) were time-locked to the onset of the first word (property) in the target trials so as to measure the effect online and to avoid a within-trial confound. A switch effect was found, characterized by more negative ERP amplitudes for modality switches than no-switches. It proved significant in four typical time windows from 160 to 750 milliseconds post word onset, with greater strength in posterior brain regions, and after 350 milliseconds. These results suggest that conceptual processing may be modality-specific in certain tasks, but also that the early stage of processing is relatively amodal. </div>'), align = 'justify'),
h4(strong(HTML('<div style="width:900px; background-color:#FEF9FF; padding-left:30px; padding-bottom:7px; padding-top:7px;"> Acknowledgements </div>'))),
h5(HTML('<div style="width:900px; text-align:left; padding-left:30px; padding-right:30px; padding-bottom:15px; font-size:15px;"> This experiment was hosted and co-funded by the <a href="https://www.mpi.nl/department/neurobiology-language/4"> Neurobiology of Language department </a> at the <a href="https://www.mpi.nl"> Max Planck Institute for Psycholinguistics</a>. </div>')),
h4(strong(HTML('<div style="width:900px; background-color:#FEF9FF; padding-left:30px; padding-bottom:7px; padding-top:7px;"> See also: Modality norms </div>'))),
h5(HTML('<div style="width:900px; text-align:left; padding-left:30px; padding-right:30px; padding-bottom:15px; font-size:15px;"><a href="https://pablobernabeu.shinyapps.io/Dutch-modality-exclusivity-norms/"><i class="glyphicon glyphicon-new-window" aria-hidden="true"></i> &#8201; Dashboard presenting the modality norms used for the stimuli of this experiment</a> (in case of website downtime, please <a href="http://rpubs.com/pcbernabeu/Dutch-modality-exclusivity-norms">visit this alternative</a>).</div>')),
br(), br(), br()
   ) )