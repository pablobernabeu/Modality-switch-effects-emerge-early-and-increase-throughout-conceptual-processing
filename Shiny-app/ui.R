...
# Dashboard reference
h4(HTML('<div style="background-color:#FEF9FF; padding-left:30px; padding-bottom:7px; padding-top:7px;"> Reference for this dashboard: </div>')),
h5(HTML('<div style = "text-indent:-30px; padding-left:60px; padding-right:30px; padding-bottom:7px; font-size:15px;"> Bernabeu, P., Willems, R. M., & Louwerse, M. M. (2017). Modality switch effects emerge early and increase throughout conceptual processing: Evidence from ERPs [Data dashboard]. Retrieved from https://pablobernabeu.shinyapps.io/ERP-waveform-visualization_CMS-experiment/.</div>'), align = 'justify'),
...
h4(strong(HTML('<div style="background-color:#FEF9FF; padding-left:30px; padding-bottom:7px; padding-top:7px;"> Acknowledgements </div>'))),
